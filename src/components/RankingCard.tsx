...
export function RankingCard({
  ...
  return (
    <Link
      ...
      className="block rounded-xl border border-[#2a2a2a] bg-[#111111] p-4 transition-colors hover:border-[#3a3a3a] hover:bg-[#141414] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#d4a853]"
    >
